...
python -m pytest tests/ -q     # 352 collected：334 passed / 18 skipped（全合成 fixture，不碰你的真实会话）
```
...
```sh
python -m pytest tests/ -q                # 352 collected：334 passed / 18 skipped —— 适配器 / 接续引擎 / 预算 / 租约 / switch / Skill / API / MCP
