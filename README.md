...
python -m pytest tests/ -q     # 336 collected: 318 passed, 18 skipped (synthetic fixtures, no provider data)
```
...
```sh
python -m pytest tests/ -q                # 336 collected: 318 passed, 18 skipped — adapters, store, continuity, budget, leases, switch, skill, API, MCP, integration
