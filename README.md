...
python -m pytest tests/ -q     # 332 collected: 314 passed, 18 skipped (synthetic fixtures, no provider data)
```
...
```sh
python -m pytest tests/ -q                # 332 collected: 314 passed, 18 skipped — adapters, store, continuity, budget, leases, switch, skill, API, MCP, integration
