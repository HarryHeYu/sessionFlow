...
python -m pytest tests/ -q     # 357 collected: 339 passed, 18 skipped (synthetic fixtures, no provider data)
```
...
```sh
python -m pytest tests/ -q                # 357 collected: 339 passed, 18 skipped — adapters, store, continuity, budget, leases, switch, skill, API, MCP, integration
