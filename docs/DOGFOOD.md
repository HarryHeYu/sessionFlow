...
### Automated Hermetic Tests (336 collected → 318 passed, 18 skipped)
...
- **Automated core verified**: `336 collected → 318 passed, 18 skipped, 0 failed` (all logic paths covered; skips are optional-dependency/platform gates)
