...
### Automated Hermetic Tests (352 collected → 334 passed, 18 skipped)
...
- **Automated core verified**: `352 collected → 334 passed, 18 skipped, 0 failed` (all logic paths covered; skips are optional-dependency/platform gates)
