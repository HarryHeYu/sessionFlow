...
### Automated Hermetic Tests (339 collected → 321 passed, 18 skipped)
...
- **Automated core verified**: `339 collected → 321 passed, 18 skipped, 0 failed` (all logic paths covered; skips are optional-dependency/platform gates)
