...
### Automated Hermetic Tests (332 collected → 314 passed, 18 skipped)
...
- **Automated core verified**: `332 collected → 314 passed, 18 skipped, 0 failed` (all logic paths covered; skips are optional-dependency/platform gates)
